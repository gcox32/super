...
export const imageTransforms: Record<string, string> = {
  ...
  [`${imagePathFront}/pec-major.svg`]: 'translateX(6px)',
  [`${imagePathFront}/deltoids.svg`]: 'translateX(6px)',
  [`${imagePathFront}/triceps-long-head.svg`]: 'translateX(6px)',
  [`${imagePathFront}/triceps-medial-head.svg`]: 'translateX(6px)',
  [`${imagePathFront}/biceps-brachii.svg`]: 'translateX(6px)',
  [`${imagePathFront}/brachialis.svg`]: 'translateX(6px)',
  [`${imagePathFront}/brachioradialis.svg`]: 'translateX(6px)',
  [`${imagePathFront}/extensor-carpi-radialis.svg`]: 'translateX(4px)',
  [`${imagePathFront}/flexor-carpi-radialis.svg`]: 'translateX(7px)',
  [`${imagePathFront}/rectus-abdominus.svg`]: 'translateX(8px)',
  [`${imagePathFront}/rectus-abdominus-lower.svg`]: 'translateX(8px)',
  [`${imagePathFront}/external-obliques.svg`]: 'translateX(-2px) translateY(1px) scale(0.6',
