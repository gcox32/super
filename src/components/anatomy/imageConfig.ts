...
export const imageTransforms: Record<string, string> = {
  ...
  [`${imagePathFront}/pec-major.svg`]: 'translateX(8px)',
  [`${imagePathFront}/deltoids.svg`]: 'translateX(7.5px)',
  [`${imagePathFront}/triceps-long-head.svg`]: 'translateX(8px)',
  [`${imagePathFront}/triceps-medial-head.svg`]: 'translateX(7.5px)',
  ...
  [`${imagePathFront}/flexor-carpi-radialis.svg`]: 'translateX(8px)',
