      ...
      <div className="md:mx-auto pb-12 md:max-w-4xl">
        <section className="space-y-12 px-4 md:px-6 py-6">
          ...
          <div className="space-y-4">
            <h2 className="font-bold text-2xl tracking-tight">The Composite Approach</h2>
          ...
          <div className="space-y-6">
            <h3 className="font-semibold text-foreground text-xl">The Algorithms</h3>
            <div className="gap-6 grid md:grid-cols-1">
              
              {/* Navy */}
              <div className="space-y-3 bg-card/50 p-6 border border-border rounded-lg">
                <h4 className="font-medium text-foreground text-lg">1. U.S. Navy Method</h4>
                ...
                <div className="space-y-1 text-muted-foreground text-sm">
                  <p><span className="font-medium text-foreground">Inputs:</span> Height, Neck, Waist, Hip (Female only)</p>
                  <p><span className="font-medium text-foreground">Strengths:</span> High correlation with hydrostatic weighing; accounts for frame size via neck measurement.</p>
                </div>
              </div>

              {/* BMI / Deurenberg */}
              <div className="space-y-3 bg-card/50 p-6 border border-border rounded-lg">
                <h4 className="font-medium text-foreground text-lg">2. Deurenberg BMI Method</h4>
                <p className="text-muted-foreground text-sm">
                ...
                <div className="space-y-1 text-muted-foreground text-sm">
                  <p><span className="font-medium text-foreground">Inputs:</span> BMI, Age, Gender</p>
                  <p><span className="font-medium text-foreground">Strengths:</span> Accounts for the natural increase in body fat with age that other linear tape methods might miss.</p>
                </div>
              </div>

              {/* YMCA */}
              <div className="space-y-3 bg-card/50 p-6 border border-border rounded-lg">
                <h4 className="font-medium text-foreground text-lg">3. YMCA Formula</h4>
                <p className="text-muted-foreground text-sm">
                ...
                <div className="space-y-1 text-muted-foreground text-sm">
                  <p><span className="font-medium text-foreground">Inputs:</span> Weight, Waist</p>
                  <p><span className="font-medium text-foreground">Strengths:</span> simple, widely used baseline.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Synthesis Section */}
          <div className="space-y-4">
            <h3 className="font-semibold text-foreground text-xl">Synthesis & Uncertainty</h3>
            <p className="text-muted-foreground leading-relaxed">
            ...
            <ul className="space-y-2 ml-2 pt-2 text-muted-foreground list-disc list-inside">
          ...
          <div className="space-y-4 pt-4 border-border border-t">
            <h3 className="font-semibold text-foreground text-lg">Validation & Sanity Checks</h3>
            <p className="text-muted-foreground text-sm">
              Before computing, Aegis runs the data through a series of biological plausibility checks to catch measurement errors:
            </p>
            <ul className="gap-4 grid grid-cols-1 md:grid-cols-2 text-muted-foreground text-sm">
              <li className="flex items-center gap-2">
                <span className="bg-brand-primary/50 rounded-full w-1.5 h-1.5" />
